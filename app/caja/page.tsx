...
export default function CajaPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-100 p-4 sm:p-6 lg:p-8 max-w-md md:max-w-7xl mx-auto pb-12">
      ...
      {/* Grid de 2 Columnas en Desktop, Apilado en Celular */}
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
        ...
        {/* Columna Derecha: Historial de Ventas del Turno */}
        <div className="md:col-span-7 bg-white rounded-2xl shadow-sm p-5">
          ...
          {ventasDelTurno.length === 0 ? (
            <p className="text-center text-gray-400 py-12 text-sm">No hay ventas registradas en este turno.</p>
          ) : (
